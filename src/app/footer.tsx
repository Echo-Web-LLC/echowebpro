    ...
    return (
        <div>
            <footer className="bg-gray-100 lg:grid lg:grid-cols-5">
                <div className="bg-gray-900 relative block h-32 lg:col-span-2 lg:h-full">
                    <Image
                        src={FooterImg}
                        alt=""
                    ...
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                        <div>
                            <p>
                                ...
                                <a
                                    href="tel:+917325158724"
                                    className="block text-lg font-medium text-gray-800 hover:opacity-75 sm:text-xl"
                                >
                                    +1(732)-515-8724
                                </a>
                            </p>
                            <p>
                                ...
                                <a
                                    href="mailto:echowebllc@gmail.com"
                                    className="block text-sm font-medium text-gray-700 sm:text-md"
                                >
                                    <span className="hover:opacity-75">echowebllc@gmail.com <br /></span>
                                    {/* <span className="hover:opacity-75">keshawn.strong@echowebpro.com<br /></span>
                                    <span className="hover:opacity-75">jenny.jung@echowebpro.com<br /></span>
                                    <span className="hover:opacity-75">martin.babak@echowebpro.com</span> */}
                                </a>
                            </p>
